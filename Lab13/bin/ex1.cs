// Dafny program ex1.dfy compiled into C#
...
// Command-line arguments: build --output bin\ex1 c:\Users\Vlad\Desktop\lab13-dafny\ex1.dfy
// ex1.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _out0;
      BigInteger _out1;
      __default.MaxSum(new BigInteger(1928), BigInteger.One, out _out0, out _out1);
      _0_s = _out0;
      _1_m = _out1;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Sum: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_s));
